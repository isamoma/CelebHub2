import sys, os
# Force SQLite mode for local testing (unset MONGO_URI)
os.environ.pop('MONGO_URI', None)

sys.path.insert(0, os.path.dirname(os.path.dirname(__file__)))
from app import create_app, DB
# Use legacy models for testing (pure SQLAlchemy, no MongoEngine)
from app.legacy_models import LegacyUser as User, LegacyCelebritySubmission as CelebritySubmission, LegacyCelebrity as Celebrity
import re
